...
export DAEMONS_CLS_PATH="$DAEMONS_CLS_PATH:$DAEMONS_HOME/lib/commons-net-2.0.jar"
...
"${JAVA_HOME}/bin/java" -classpath "$DAEMONS_CLS_PATH"  tower.cem.daemons.StopTelnetDaemons