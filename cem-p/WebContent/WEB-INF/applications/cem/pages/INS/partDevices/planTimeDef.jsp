                ...
                <tr>
                  ...
                  <td align="center"> 
                   ...
                   <td  align="left">
                    <span id="date">
                   <span id="sprytDate">
                   日期：<input   type="text" class="date" name="DATE" readonly><input type="button" class="calendarBtn" onclick="return showCalendar('DATE', 'y-mm-dd');"><span class="requiredField">*</span>
