...
<form name="form1" action="ctrl" method="get"><input
	type="hidden" name="FUNC_ID" value="Disconnection"> <input
	type="hidden" name="COMMANDS"> <input type="hidden"
	name="EXEC_BEGIN" value="<%=date %>"> <input type="hidden"
...
<table width="100%">
	<tr>
		<td align="center"><applet name="TelnetApplet"
			code="de.mud.jta.Applet" codebase="../sys/applet/"
			archive="jta26.jar" width=800 height=550>
