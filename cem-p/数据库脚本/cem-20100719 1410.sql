...
INSERT INTO `commands_send_list` (`SEND_ID`,`USER_ID`,`DEVICE_TYPE_ID`,`DEVICE_ID`,`TASK_DEFINE_TIME`,`TASK_PLAN_TIME`,`COMMANDS_TYPE`,`TEMPLATE_ID`,`STATUS`) VALUES 
 ('0000000006','000000',NULL,'000001','20100718101704','20100718101704','T','','N'),
 ('0000000007','000000',NULL,'000001','20100718102119','20100718102119','T','','N'),
 ('0000000008','000000',NULL,'000001','20100718113007','20100718113007','T','000004','N'),
 ('0000000009','000000',NULL,'000001','20100718144141','20100718144141','T','000006','N'),
 ('0000000011','000000',NULL,'000001','20100718162106','20100718162106','T','000006','N'),
 ('0000000012','000000',NULL,'000001','20100718162230','20100718162230','T','000004','N'),
 ('0000000013','000000',NULL,'000001','20100718162635','20100718162635','T','000006','N'),
 ('0000000015','000000','000007','000001','20100718163149','20100718163149','T','000006','N'),
 ('0000000016','000000','000007','000009','20100718223614','20100718223614','T','000006','N'),
 ('0000000017','000000','000007','000001','20100718223715','20100718223715','T','000006','N'),
 ('0000000018','000000','000007','000001','20100718234824','20100718234824','T','000006','N');
...
INSERT INTO `device_info` (`DEVICE_ID`,`DEVICE_NAME_EN`,`DEVICE_ABB_NAME_EN`,`DEVICE_NAME_CN`,`TYPE_ID`,`LOCATION_ID`,`DEVICE_STATUS`,`FRONT_HOST_ID`,`DEVICE_IP`,`DEVICE_PORT`,`DEVICE_USER`,`DEVICE_PASSWORD`,`DEVICE_PROMPT`,`REMARK`) VALUES 
 ('000001','1111111111','1','1','000007','000002','N','000003','192.168.1.251','23','ecode315','password','$',''),
 ('000009','1G','','1G','','','S','','1','1','1','G','G','');
...
CREATE TABLE `device_inspect_pick_log` (
  ...
  `DEVICE_IP` varchar(50) default NULL,
  `LOCATION_ID` char(6) default NULL,
  `PICK_KEYWORD` varchar(50) default NULL,
...
INSERT INTO `device_inspect_pick_log` (`SEND_ID`,`DEVICE_ID`,`DEVICE_NAME`,`DEVICE_IP`,`LOCATION_ID`,`PICK_KEYWORD`,`PICK_TIME`,`LOG_CONT`) VALUES 
 ('0000000014','000001','1111111111','192.168.1.251','null','VerifyServer','20100716162328',' ls\r\nDesktop		 dataimport	  keymanager	   sqlnet.log\r\nbin		 dq		  keys		   ssm\r\ncarddatagen	 ecode_env	  lib		   testclient\r\nconfigdb_pw.esp  ecoderadius	  logvalidator	   verifyserver\r\ncryptoconfig	 keyimport	  siteconfig\r\n-bash-3.00$'),
 ('0000000014','000001','1111111111','192.168.1.251','null','boot','20100716162328',' df\r\nFilesystem           1K-blocks      Used Available Use% Mounted on\r\n/dev/mapper/VolGroup00-LogVol00\r\n                     138658832  66747804  64867548  51% /\r\n/dev/sda1               101086     12721     83146  14% /boot\r\nnone                   1037368         0   1037368   0% /dev/shm\r\n-bash-3.00$');
...
INSERT INTO `device_port_info` (`PORT_ID`,`DEVICE_ID`,`PORT_SN`,`TYPE_ID`,`STATUS`,`REMARK`) VALUES 
 ('000000','000001','11','000004','N','11'),
 ('000005','','12','000004','N','12'),
 ('000006','000009','1','000004','N',''),
 ('000007','000001','','','N',''),
 ('000010','000009','11212','000004','N','1212');
...
INSERT INTO `device_type` (`TYPE_ID`,`TYPE_NAME_EN`,`TYPE_NAME_CN`,`INSPECT_COMMANDS`,`INSPECT_COMMANDS_EXP`,`COLLECT_COMMANDS`,`RXP_LINE_START`,`RXP_VALUE_START`,`RXP_VALUE_END`,`RXP_VALUE_POS`,`APP_PICTURE`,`REMARK`) VALUES 
 ('000001','dt001','测试设备1','df\r\npwd\r\nls','','df','/dev/sda1','/dev/sda1','%','2',NULL,'');
...
INSERT INTO `front_host_info` (`HOST_ID`,`HOST_NAME_EN`,`HOST_ABB_NAME_EN`,`HOST_NAME_CN`,`LOCATION_ID`,`HOST_STATUS`,`HOST_IP`,`HOST_PORT`,`HOST_USER`,`HOST_PASSWORD`,`HOST_PROMPT`,`REMARK`) VALUES 
 ...
 ('000001','','','','','N','','','','','',''),
 ('000003','1','1','1','000004','N','60.209.94.194','23','ecode315','password','$',''),
...
INSERT INTO `maintain_team_device_map` (`MAP_ID`,`TEAM_ID`,`DEVICE_ID`) VALUES 
 ...
 ('000008','000005','000001'),
 ('000011','000002','000001'),
 ('000014','000005','000009');
...
INSERT INTO `maintain_team_user_map` (`MAP_ID`,`TEAM_ID`,`USER_ID`) VALUES 
 ('000010','000002','000000'),
 ('000013','000005','000000');
...
INSERT INTO `sys_id_creator` (`CREATOR_ID`,`CREATOR_VALUE`,`CREATOR_REMARK`) VALUES 
 ('DEVICE_ID','10','Next ID of DEVICE_ID'),
 ('DEVICE_TYPE_ID','19','Next ID of DEVICE_TYPE_ID'),
 ('HOST_ID','8','Next ID of HOST_ID'),
 ('LOCATION_ID','8','Next ID of LOCATION_ID'),
 ('MAP_ID','15','Next ID of MAP_ID'),
 ('ORG_ID','1','Next ID of ORG_ID'),
 ('PORT_ID','11','Next ID of PORT_ID'),
 ('SEND_ID','19','Next ID of SEND_ID'),
 ('STAT_ID','1','Next ID of STAT_ID'),
 ('TEAM_ID','7','Next ID of TEAM_ID'),
 ('TEMP_ID','7','Next ID of TEMP_ID'),
 ('TYPE_ID','14','Next ID of TYPE_ID'),
...
INSERT INTO `sys_menu` (`MENU_ID`,`MENU_NAME`,`MENU_TYPE`,`MENU_LVL`,`PARENT_ID`,`SORT_NO`,`MENU_URL`,`MENU_DESC`) VALUES 
 ...
 ('DevicePortTypeList','设备端口类型管理','M',1,'DeviceTypeListTo',0,NULL,NULL),
 ...
 ('DeviceTypeListJsp','设备类型管理','M',1,'DeviceTypeListTo',0,NULL,NULL),
 ('DeviceTypeListTo','设备类型管理','M',1,'MainListBase',3,NULL,NULL),
