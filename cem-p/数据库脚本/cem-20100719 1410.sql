...
INSERT INTO `commands_send_his` (`SEND_ID`,`USER_ID`,`DEVICE_TYPE_ID`,`DEVICE_ID`,`TASK_DEFINE_TIME`,`TASK_PLAN_TIME`,`COMMANDS_TYPE`,`TEMPLATE_ID`,`STATUS`,`EXEC_BEGIN_TIME`,`EXEC_END_TIME`) VALUES 
 ...
 ('0000000023','000001','000001',NULL,'20001212111111','20001212111111','I',NULL,'S','20100716214641','20100716214644'),
 ('0000000024','1','',NULL,'1','1','I',NULL,'S','20100716215941','20100716215953'),
 ('0000000030','11',NULL,'000001','1','1','C',NULL,'S','20100719140509','20100719140510');
...
INSERT INTO `device_collect_log` (`SEND_ID`,`DEVICE_ID`,`DEVICE_NAME`,`DEVICE_IP`,`USER_ID`,`COLLECT_BEGIN`,`COLLECT_END`,`STATUS`,`LOG_CONT`) VALUES 
 ...
 ('0000000030','000001','device000001','60.209.94.194','11','20100719140509','20100719140510','S','Red Hat Enterprise Linux ES release 4 (Nahant Update 4)\r\nKernel 2.6.9-42.ELsmp on an i686\r\nlogin:\n Password:\r\nLast login: Mon Jul 19 14:03:12 from 192.168.1.251\r\n-bash-3.00$ df\r\nFilesystem           1K-blocks      Used Available Use% Mounted on\r\n/dev/mapper/VolGroup00-LogVol00\r\n                     138658832  66750052  64865300  51% /\r\n/dev/sda1               101086     12721     83146  14% /boot\r\nnone                   1037368         0   1037368   0% /dev/shm\r\n-bash-3.00$');
...
INSERT INTO `device_info` (`DEVICE_ID`,`DEVICE_NAME_EN`,`DEVICE_ABB_NAME_EN`,`DEVICE_NAME_CN`,`TYPE_ID`,`LOCATION_ID`,`DEVICE_STATUS`,`FRONT_HOST_ID`,`DEVICE_IP`,`DEVICE_PORT`,`DEVICE_USER`,`DEVICE_PASSWORD`,`DEVICE_PROMPT`,`REMARK`) VALUES 
 ('000001','device000001','dev01','测试设备1','000001','000002','N','','60.209.94.194','23','ecode315','password','$',''),
 ('000002','device000002','dev02','测试设备2','000001','000002','N','000002','192.168.1.254','23','oracle','password','$','');
...
INSERT INTO `device_inspect_log` (`SEND_ID`,`DEVICE_ID`,`DEVICE_NAME`,`DEVICE_IP`,`USER_ID`,`INSPECT_BEGIN`,`INSPECT_END`,`STATUS`,`LOG_CONT`) VALUES 
 ...
 ('0000000023','000001','1111111111','60.209.94.194','000001','20100716214641','20100716214642','S','Red Hat Enterprise Linux ES release 4 (Nahant Update 4)\r\nKernel 2.6.9-42.ELsmp on an i686\r\nlogin:\n Password:\r\nLast login: Fri Jul 16 21:30:48 from 119.165.132.29\r\n-bash-3.00$ ls\r\nDesktop		 dataimport	  keymanager	   sqlnet.log\r\nbin		 dq		  keys		   ssm\r\ncarddatagen	 ecode_env	  lib		   testclient\r\nconfigdb_pw.esp  ecoderadius	  logvalidator	   verifyserver\r\ncryptoconfig	 keyimport	  siteconfig\r\n-bash-3.00$ pwd\r\n/home/ecode315\r\n-bash-3.00$ df\r\nFilesystem           1K-blocks      Used Available Use% Mounted on\r\n/dev/mapper/VolGroup00-LogVol00\r\n                     138658832  66747840  64867512  51% /\r\n/dev/sda1               101086     12721     83146  14% /boot\r\nnone                   1037368         0   1037368   0% /dev/shm\r\n-bash-3.00$'),
 ('0000000023','000002','2222222222','192.168.1.254','000001','20100716214642','20100716214644','S','Red Hat Enterprise Linux ES release 4 (Nahant Update 4)\r\nKernel 2.6.9-42.ELsmp on an i686\r\nlogin:\n Password:\r\nLast login: Fri Jul 16 21:46:27 from 119.165.132.29\r\n-bash-3.00$ telnet 192.168.1.254 23\r\nTrying 192.168.1.254...\r\r\nConnected to 192.168.1.254 (192.168.1.254).\r\r\nEscape character is \'^]\'.\r\r\n\r\n\r\ntelnet (AIXserver)\r\n\r\r\n\r\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\rAIX Version 5\r\n\r(C) Copyrights by IBM and by others 1982, 2005.\r\n\rlogin: oracle\r\noracle\'s Password: \r\n*******************************************************************************\r\n*                                                                             *\r\n*                                                                             *\r\n*  Welcome to AIX Version 5.2!                                                *\r\n*                                                                             *\r\n*                                                                             *\r\n*  Please see the README file in /usr/lpp/bos for information pertinent to    *\r\n*  this release of the AIX Operating System.                                  *\r\n*                                                                             *\r\n*                                                                             *\r\n*******************************************************************************\r\nLast unsuccessful login: Mon Jun 21 16:50:07 BEIST 2010 on /dev/pts/4 from 192.168.1.251\r\nLast login: Fri Jul 16 21:34:00 BEIST 2010 on /dev/pts/0 from 192.168.1.251\r\n\r\n$ ls\r\nDisk1         Disk1.zip     OraHome_1     oraInventory\r\n$ pwd\r\n/home/oracle\r\n$ df\r\nFilesystem    512-blocks      Free %Used    Iused %Iused Mounted on\r\n/dev/hd4         2097152   1172400   45%     2084     1% /\r\n/dev/hd2        10354688   1606576   85%    64904     6% /usr\r\n/dev/hd9var      2097152   1892808   10%      814     1% /var\r\n/dev/hd3         4194304   1288264   70%    14618     3% /tmp\r\n/dev/hd1        30670848   8843368   72%    76119     2% /home\r\n/proc                  -         -    -         -     -  /proc\r\n/dev/hd10opt     4194304   3418408   19%     3512     1% /opt\r\n$'),
 ('0000000024','000001','1111111111','60.209.94.194','1','20100716215941','20100716215952','S','Red Hat Enterprise Linux ES release 4 (Nahant Update 4)\r\nKernel 2.6.9-42.ELsmp on an i686\r\nlogin:\n Password:\r\nLast login: Fri Jul 16 21:46:28 from 119.165.132.29\r\n-bash-3.00$ ls\r\nDesktop		 dataimport	  keymanager	   sqlnet.log\r\nbin		 dq		  keys		   ssm\r\ncarddatagen	 ecode_env	  lib		   testclient\r\nconfigdb_pw.esp  ecoderadius	  logvalidator	   verifyserver\r\ncryptoconfig	 keyimport	  siteconfig\r\n-bash-3.00$ pwd\r\n/home/ecode315\r\n-bash-3.00$ df\r\nFilesystem           1K-blocks      Used Available Use% Mounted on\r\n/dev/mapper/VolGroup00-LogVol00\r\n                     138658832  66747840  64867512  51% /\r\n/dev/sda1               101086     12721     83146  14% /boot\r\nnone                   1037368         0   1037368   0% /dev/shm\r\n-bash-3.00$'),
 ('0000000024','000002','2222222222','192.168.1.254','1','20100716215952','20100716215953','S','Red Hat Enterprise Linux ES release 4 (Nahant Update 4)\r\nKernel 2.6.9-42.ELsmp on an i686\r\nlogin:\n Password:\r\nLast login: Fri Jul 16 21:59:36 from 119.165.132.29\r\n-bash-3.00$ telnet 192.168.1.254 23\r\nTrying 192.168.1.254...\r\r\nConnected to 192.168.1.254 (192.168.1.254).\r\r\nEscape character is \'^]\'.\r\r\n\r\n\r\ntelnet (AIXserver)\r\n\r\r\n\r\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\rAIX Version 5\r\n\r(C) Copyrights by IBM and by others 1982, 2005.\r\n\rlogin: oracle\r\noracle\'s Password: \r\n*******************************************************************************\r\n*                                                                             *\r\n*                                                                             *\r\n*  Welcome to AIX Version 5.2!                                                *\r\n*                                                                             *\r\n*                                                                             *\r\n*  Please see the README file in /usr/lpp/bos for information pertinent to    *\r\n*  this release of the AIX Operating System.                                  *\r\n*                                                                             *\r\n*                                                                             *\r\n*******************************************************************************\r\nLast unsuccessful login: Mon Jun 21 16:50:07 BEIST 2010 on /dev/pts/4 from 192.168.1.251\r\nLast login: Fri Jul 16 21:49:40 BEIST 2010 on /dev/pts/0 from 192.168.1.251\r\n\r\n$ ls\r\nDisk1         Disk1.zip     OraHome_1     oraInventory\r\n$ pwd\r\n/home/oracle\r\n$ df\r\nFilesystem    512-blocks      Free %Used    Iused %Iused Mounted on\r\n/dev/hd4         2097152   1172400   45%     2084     1% /\r\n/dev/hd2        10354688   1606576   85%    64904     6% /usr\r\n/dev/hd9var      2097152   1892808   10%      814     1% /var\r\n/dev/hd3         4194304   1288264   70%    14618     3% /tmp\r\n/dev/hd1        30670848   8843368   72%    76119     2% /home\r\n/proc                  -         -    -         -     -  /proc\r\n/dev/hd10opt     4194304   3418408   19%     3512     1% /opt\r\n$');
...
INSERT INTO `device_inspect_pick_log` (`SEND_ID`,`PICK_TIME`,`LOG_CONT`) VALUES 
 ...
 ('0000000023','20100716214644','DeviceId:000001 DeviceNameEn:1111111111 DeviceIP:60.209.94.194 KeyWord:VerifyServer\n$ ls\r\nDesktop		 dataimport	  keymanager	   sqlnet.log\r\nbin		 dq		  keys		   ssm\r\ncarddatagen	 ecode_env	  lib		   testclient\r\nconfigdb_pw.esp  ecoderadius	  logvalidator	   verifyserver\r\ncryptoconfig	 keyimport	  siteconfig\r\n-bash-3.00$\n\nDeviceId:000001 DeviceNameEn:1111111111 DeviceIP:60.209.94.194 KeyWord:boot\n$ df\r\nFilesystem           1K-blocks      Used Available Use% Mounted on\r\n/dev/mapper/VolGroup00-LogVol00\r\n                     138658832  66747840  64867512  51% /\r\n/dev/sda1               101086     12721     83146  14% /boot\r\nnone                   1037368         0   1037368   0% /dev/shm\r\n-bash-3.00$\n\nDeviceId:000002 DeviceNameEn:2222222222 DeviceIP:192.168.1.254 KeyWord:Oracle\n$ pwd\r\n/home/oracle\r\n$\n\n'),
 ('0000000024','20100716215953','DeviceId:000001 DeviceNameEn:1111111111 DeviceIP:60.209.94.194 KeyWord:VerifyServer\n$ ls\r\nDesktop		 dataimport	  keymanager	   sqlnet.log\r\nbin		 dq		  keys		   ssm\r\ncarddatagen	 ecode_env	  lib		   testclient\r\nconfigdb_pw.esp  ecoderadius	  logvalidator	   verifyserver\r\ncryptoconfig	 keyimport	  siteconfig\r\n-bash-3.00$\n\nDeviceId:000001 DeviceNameEn:1111111111 DeviceIP:60.209.94.194 KeyWord:boot\n$ df\r\nFilesystem           1K-blocks      Used Available Use% Mounted on\r\n/dev/mapper/VolGroup00-LogVol00\r\n                     138658832  66747840  64867512  51% /\r\n/dev/sda1               101086     12721     83146  14% /boot\r\nnone                   1037368         0   1037368   0% /dev/shm\r\n-bash-3.00$\n\nDeviceId:000002 DeviceNameEn:2222222222 DeviceIP:192.168.1.254 KeyWord:Oracle\n$ pwd\r\n/home/oracle\r\n$\n\n');
...
INSERT INTO `device_port_rxp` (`SEND_ID`,`DEVICE_ID`,`DEVICE_NAME`,`PORT_ID`,`PORT_SN`,`RXP`) VALUES 
 ('0000000030','000001','device000001','000001','sn','12721.00');
...
INSERT INTO `device_port_type` (`TYPE_ID`,`TYPE_NAME_EN`,`TYPE_NAME_CN`,`STANDARD_RX_MAX`,`STANDARD_RX_MIN`,`NETWORK_RX_MIN`,`REMARK`) VALUES 
 ...
 ('000004','111','111','1.00','1.00','99999999.99','');
...
INSERT INTO `device_type` (`TYPE_ID`,`TYPE_NAME_EN`,`TYPE_NAME_CN`,`INSPECT_COMMANDS`,`INSPECT_COMMANDS_EXP`,`COLLECT_COMMANDS`,`RXP_LINE_START`,`RXP_VALUE_START`,`RXP_VALUE_END`,`RXP_VALUE_POS`,`APP_PICTURE`,`REMARK`) VALUES 
 ('000001','dt01','设备类型01','pwd\r\nls\r\ndf',NULL,'df','/dev/sda1','/dev/sda1',NULL,'2',NULL,NULL);
...
INSERT INTO `maintain_team` (`TEAM_ID`,`TEAM_NAME`,`REMARK`) VALUES 
 ('000002','第一维护团队','No.1 Maintain team\r\n'),
 ('000003','DF3','DF3'),
 ('000005','二二地方','东方大飞');
