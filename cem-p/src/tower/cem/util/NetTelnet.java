...
public class NetTelnet {
	 ...
	 */
	public String FunLogin(String ip, String port, String loginPrompt,
			String user, String passwordPrompt, String password, String prom) {
	 ...
	 * @return 登录过程的提示信息；登录失败时返回null，通常是由于地址、端口、用户名或者密码错误，以及可能的命令行提示符设置错误导致。
	 */
	public String FunRelogin(String ip, String port, String loginPrompt,
			String user, String passwordPrompt, String password, String prom) {
	...
	public static void main(String[] args) {
		try {
			...
			// 例子1：直接登录设备
			System.out.println("\n\n例子1：直接登录设备。");
			result = telnet.FunLogin("60.209.94.194", "23", "login:",
					"ecode315", "Password:", "password", "$");
			...
			if (telnet.getBflag() == false) {
				...
				result = telnet.FunRelogin("192.168.1.254", "23", "login:",
