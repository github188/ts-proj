...
public class DbDeviceType extends RootDB{
    ...
    public int insert (EnDeviceType en) throws ErrorException {
        ...
        query.append("insert into device_type ( TYPE_ID,TYPE_NAME_EN,TYPE_NAME_CN,INSPECT_COMMANDS,INSPECT_COMMANDS_EXP,COLLECT_COMMANDS,CONFIG_COMMANDS,RXP_LINE_START,RXP_VALUE_START,RXP_VALUE_END,RXP_VALUE_POS,APP_PICTURE,REMARK,PROMPT_LINES ) values ( ");
    ...
    */
    public EnDeviceType findByKey(String typeId) throws ErrorException {
        ...
        StringBuffer query;
        query = new StringBuffer("select TYPE_ID,TYPE_NAME_EN,TYPE_NAME_CN,INSPECT_COMMANDS,INSPECT_COMMANDS_EXP,COLLECT_COMMANDS,CONFIG_COMMANDS,RXP_LINE_START,RXP_VALUE_START,RXP_VALUE_END,RXP_VALUE_POS,APP_PICTURE,REMARK,PROMPT_LINES from device_type");
    ...
    public Vector findAllLikeKey(String typeId) throws ErrorException {
        ...
        StringBuffer query = new StringBuffer();
        query.append("select TYPE_ID,TYPE_NAME_EN,TYPE_NAME_CN,INSPECT_COMMANDS,INSPECT_COMMANDS_EXP,COLLECT_COMMANDS,CONFIG_COMMANDS,RXP_LINE_START,RXP_VALUE_START,RXP_VALUE_END,RXP_VALUE_POS,APP_PICTURE,REMARK,PROMPT_LINES from device_type");
    ...
    public Vector findAllWhere(String where) throws ErrorException {
        ...
        StringBuffer query = new StringBuffer();
        query.append("select TYPE_ID,TYPE_NAME_EN,TYPE_NAME_CN,INSPECT_COMMANDS,INSPECT_COMMANDS_EXP,COLLECT_COMMANDS,CONFIG_COMMANDS,RXP_LINE_START,RXP_VALUE_START,RXP_VALUE_END,RXP_VALUE_POS,APP_PICTURE,REMARK,PROMPT_LINES from device_type where ");
        query.append(where);
        if(orderBy != null) {
            query.append(orderBy);
        }
    ...
    public Vector findAllByEn(EnDeviceType en) throws ErrorException {
        ...
        if(bChanged) {
            query.insert(0,"select TYPE_ID,TYPE_NAME_EN,TYPE_NAME_CN,INSPECT_COMMANDS,INSPECT_COMMANDS_EXP,COLLECT_COMMANDS,CONFIG_COMMANDS,RXP_LINE_START,RXP_VALUE_START,RXP_VALUE_END,RXP_VALUE_POS,APP_PICTURE,REMARK,PROMPT_LINES from device_type where ");
        } else {
            query.append("select TYPE_ID,TYPE_NAME_EN,TYPE_NAME_CN,INSPECT_COMMANDS,INSPECT_COMMANDS_EXP,COLLECT_COMMANDS,CONFIG_COMMANDS,RXP_LINE_START,RXP_VALUE_START,RXP_VALUE_END,RXP_VALUE_POS,APP_PICTURE,REMARK,PROMPT_LINES from device_type");
        }
        if(orderBy != null) {
