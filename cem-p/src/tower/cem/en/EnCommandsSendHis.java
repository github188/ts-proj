...
public class EnCommandsSendHis implements java.io.Serializable {
    /**
    ...
    /**
     * Type : char(14) Name : EXEC_BEGIN_TIME
     */
    private String execBeginTime;

    /**
     * Type : char(14) Name : EXEC_END_TIME
     */
    ...
    /**
     * Type : char(14) Name : EXEC_BEGIN_TIME modify flag
     */
    private boolean _flagExecBeginTime;

    /**
     * Type : char(14) Name : EXEC_END_TIME modify flag
     */
    private boolean _flagExecEndTime;
    ...
    /**
     * Sets the value for execBeginTime
     */
    public void setExecBeginTime(String execBeginTime) {
        this.execBeginTime = execBeginTime;
        this._flagExecBeginTime = true;
    }

    /**
     * Gets the value for execBeginTime
     */
    ...
    /**
     * has the value for execBeginTime changed?
     */
    public boolean hasChangeExecBeginTime() {
        return _flagExecBeginTime;
    }

    /**
     * Sets the value for execEndTime
     */
    public void setExecEndTime(String execEndTime) {
        this.execEndTime = execEndTime;
        this._flagExecEndTime = true;
    }

    /**
     * Gets the value for execEndTime
     */
    ...
    /**
     * has the value for execEndTime changed?
     */
    public boolean hasChangeExecEndTime() {
        return _flagExecEndTime;
    }
