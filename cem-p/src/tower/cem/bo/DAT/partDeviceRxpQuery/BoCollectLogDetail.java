...
public class BoCollectLogDetail implements RootBo{
	...
	vector = dbDeviceCollectLog.findAllWhere(" send_id='"+sendId+"'");
	...
	requestXml.setItemValue("DEVICE_COLLECT_LOG", row, "DEVICE_NAME_CN", enDeviceInfo.getDeviceNameCn());
	requestXml.setItemValue("DEVICE_COLLECT_LOG", row, "DEVICE_NAME_EN", enDeviceInfo.getDeviceNameEn());
