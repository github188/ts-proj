...
/**
 * 功能描述：为维护团队增加维护设备
 * 1、根据维护团队编号从维护团队与设备对照表（MAINTAIN_TEAM_DEVICE_MAP）中删除所有对应维护设备信息。
...
public class BoMaintainDeviceSubmit implements RootBo{
	...
	public void doBusiness(Transaction transaction, XMLWrap requestXml,
		 ...
		 * 执行业务逻辑、输出
		 **********************************************************************/
		//根据维护团队编号从维护团队与设备对照表（MAINTAIN_TEAM_DEVICE_MAP）中删除所有对应维护设备信息。
		...
		for( int i = 0;i < deviceIds.length;i++){
			mapId = SysIdCreator.GenNextId(transaction, null,
					IdCreatorDefine.ID_TYPE_TEAM_DEVICE_MAP_ID,
