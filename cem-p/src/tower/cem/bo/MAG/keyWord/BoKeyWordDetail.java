...
public class BoKeyWordDetail implements RootBo{
	 ...
	 public void doBusiness(Transaction transaction, XMLWrap requestXml, XMLWrap sessionXml,
			...
			/***********************************************************************
		         * 执行业务逻辑、输出
		         **********************************************************************/
			//根据设备巡检分拣关键字编号（keyWordId）获取关键字信息
			enInspectPickKeyword =dbInspectPickKeyword.findByKey(keyWordId);
			dbInspectPickKeyword.setToXml(requestXml, enInspectPickKeyword);
