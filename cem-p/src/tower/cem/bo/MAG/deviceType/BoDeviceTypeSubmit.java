...
public class BoDeviceTypeSubmit implements RootBo {
	...
	// 上传文件第2步:获取上传文件工厂
	uploadFileFactory = (UploadFileFactory) applicationXml.getInputObject("uploadFileFactory");
	...
	sql1 = new StringBuffer(" TYPE_NAME_EN ='" + typeNameEn + "'");

	sql2 = new StringBuffer(" TYPE_NAME_CN ='" + typeNameCn + "'");
