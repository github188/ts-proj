 ...
 *
 */
 public class ServletInspectLogTxt extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
	 ...
	 private static final long serialVersionUID = 7982396433338743263L;
		...
		throws ServletException, IOException {
			...
			deviceName = xml.getItemValue("DEVICE_INSPECT_LOG",1,"TYPE_NAME");
			deviceIp = xml.getItemValue("DEVICE_INSPECT_LOG",1,"DEVICE_IP");
			userId = xml.getItemValue("DEVICE_INSPECT_LOG",1,"USER_ID");
			userName = xml.getItemValue("DEVICE_INSPECT_LOG",1,"USER_NAME");
			...
			fileName = "inspect_"+deviceIp+"_"+inspectEnd+".txt";;
