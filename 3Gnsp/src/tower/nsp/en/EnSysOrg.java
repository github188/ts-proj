...
public class EnSysOrg implements java.io.Serializable {
    ...
    /**
     * Type : varchar(20) Name : FRE_POINT
     */
    private String frePoint;

    /**
     * Type : varchar(20) Name : PER_CODE
     */
    private String perCode;

    /**
     * Type : char(1) Name : ORG_TYPE
     */
    ...
    /**
     * Type : varchar(20) Name : FRE_POINT modify flag
     */
    private boolean _flagFrePoint;

    /**
     * Type : varchar(20) Name : PER_CODE modify flag
     */
    private boolean _flagPerCode;

    /**
     * Type : char(1) Name : ORG_TYPE modify flag
     */
    private boolean _flagOrgType;
    ...
    /**
     * Sets the value for frePoint
     */
    public void setFrePoint(String frePoint) {
        this.frePoint = frePoint;
        this._flagFrePoint = true;
    }

    /**
     * Gets the value for frePoint
     */
    ...
    /**
     * has the value for frePoint changed?
     */
    public boolean hasChangeFrePoint() {
        return _flagFrePoint;
    }

    /**
     * Sets the value for perCode
     */
    public void setPerCode(String perCode) {
        this.perCode = perCode;
        this._flagPerCode = true;
    }

    /**
     * Gets the value for perCode
     */
    ...
    /**
     * has the value for perCode changed?
     */
    public boolean hasChangePerCode() {
        return _flagPerCode;
    }

    /**
     * Sets the value for orgType
     */
    public void setOrgType(String orgType) {
        this.orgType = orgType;
        this._flagOrgType = true;
    }

    /**
     * Gets the value for orgType
     */
    ...
    /**
     * has the value for orgType changed?
     */
    public boolean hasChangeOrgType() {
        return _flagOrgType;
    }
