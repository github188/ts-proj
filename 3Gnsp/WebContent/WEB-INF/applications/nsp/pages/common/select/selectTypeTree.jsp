...
<!-- 
  位置：/nsp/pages/common/selectTypeTree.jsp
  作者：范丽娟
  页面描述：
    a)只可以选择资源型号
	...
	treeHtmlBuilder.setTreeNodeBuilder(new CommonTreeNodeBuilder(){
		 public void writeInput() {
			    ...
			    if (parameter.getInputType() != null) {
			      ...
			      html.append(formatAttr("parentValue", orgNode.getParentId()));
			      html.append(formatAttr("text", orgNode.getNodeName()));
			      if (orgNode.getParentId() == null || orgNode.getParentId().equals("")) {
...
%>
<div class="panelInnerHead">资源型号树</div>
<div id="orgTree">
<!-- 菜单树 -->  
<%=treeHtml %>
<!-- 菜单树 -->	
