...
<body id="mainArea">
  ...
  <script type="text/javascript">spryProduceFactory
<!--
...
var sprytextfield5 = new Spry.Widget.ValidationTextField("spryProduceFactory","none", {required:false,maxChars:50});	
var sprytextfield6 = new Spry.Widget.ValidationTextField("spryRemark", "none", {maxChars:100});
