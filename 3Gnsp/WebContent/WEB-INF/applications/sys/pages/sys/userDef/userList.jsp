...
<!--
  ...
  function doSelUserOrg(){
    selDialog("ctrl?FUNC_ID=SelectOrg","QUSER_ORG_ID","QUSER_ORG_NAME");
  }
  function doSelUserStat(){
    selDialog("ctrl?FUNC_ID=SelectStat","QUSER_STAT_ID","QUSER_STAT_NAME");
  }
...
<% 
        ...
        String userOrgName = xml.getInputValue("QUSER_ORG_NAME");
        String userStatId = xml.getInputValue("QUSER_STAT_ID");
        String userStatName= xml.getInputValue("QUSER_STAT_NAME");
             ...
             <form name="form1" action="ctrl" method="get">
              ...
              <table>
                <tr>
                  ...
                  <td><input type="text" class="text" size = "25" name="QUSER_NAME" value="<%=userName %>"></td>
				 ...
				 <tr> 
                  ...
                  <td>
                    <script>var org = new Tower.Widget.Selector("OrgSelector","QUSER_ORG_ID","ctrl?FUNC_ID=SelectOrg&INPUT_TYPE=radio",{selected:["<%=userOrgId%>"]},{change:onChange})</script>
                 </td>
                <td align="right">用户岗位：</td>
                  <td>
                   <input name="QUSER_STAT_ID" type="hidden" value="<%=userStatId %>" >
	               <input name="QUSER_STAT_NAME" type="text" size = "12" class="text" value="<%=userStatName %>" >
	               <input type="button" name="selectType" class="selButton" value="选择" onClick="doSelUserStat();" />
				  </td>
                </tr>
                <tr>
                  <td align="right">联系电话：</td>
                  <td><input type="text" class="text" size="25" name="QLINK_TELE"value="<%=linkTele %>"></td>
                  <td align="right">电子邮件：</td>
                  <td><input type="text" class="text" size = "20" name="QLINK_EMAIL"value="<%=linkEmail %>"></td>
