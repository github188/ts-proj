...
public class AmountStatEveryList implements RootBo {
	 ...
	 */
	public void result(Transaction transaction, XMLWrap requestXml, String name, String orgId, String typeId)
			throws ErrorException {
		...
		/*
		 * SELECT * FROM nsp.resource_org_amount r where org_id in(select org_id from nsp.sys_org where
		 * parent_id = "000003") or org_id = "000003";
		 */
		...
		Page.SetPageInfo(transaction, null, requestXml, dbResourceOrgAmount, PubFunc.LEN_PAGE_COUNT,
				"RESOURCE_ORG_AMOUNT", sql.toString());
