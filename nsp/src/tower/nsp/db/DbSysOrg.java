...
public class DbSysOrg extends RootDB{
    ...
    public int insert (EnSysOrg en) throws ErrorException {
        ...
        query.append("insert into sys_org ( ORG_ID,ORG_NAME,ORG_CODE,PARENT_ID,ORG_DESC,LINK_MAN,LINK_TELE,LINK_EMAIL,STATION_FLAG,BUY_IN_FLAG ) values ( ");
    ...
    */
    public EnSysOrg findByKey(String orgId) throws ErrorException {
        ...
        StringBuffer query;
        query = new StringBuffer("select ORG_ID,ORG_NAME,ORG_CODE,PARENT_ID,ORG_DESC,LINK_MAN,LINK_TELE,LINK_EMAIL,STATION_FLAG,BUY_IN_FLAG from sys_org");
    ...
    public Vector findAllLikeKey(String orgId) throws ErrorException {
        ...
        StringBuffer query = new StringBuffer();
        query.append("select ORG_ID,ORG_NAME,ORG_CODE,PARENT_ID,ORG_DESC,LINK_MAN,LINK_TELE,LINK_EMAIL,STATION_FLAG,BUY_IN_FLAG from sys_org");
    ...
    public Vector findAllWhere(String where) throws ErrorException {
        ...
        StringBuffer query = new StringBuffer();
        query.append("select ORG_ID,ORG_NAME,ORG_CODE,PARENT_ID,ORG_DESC,LINK_MAN,LINK_TELE,LINK_EMAIL,STATION_FLAG,BUY_IN_FLAG from sys_org where ");
        query.append(where);
        if(orderBy != null) {
            query.append(orderBy);
        }
    ...
    public Vector findAllByEn(EnSysOrg en) throws ErrorException {
        ...
        if(bChanged) {
            query.insert(0,"select ORG_ID,ORG_NAME,ORG_CODE,PARENT_ID,ORG_DESC,LINK_MAN,LINK_TELE,LINK_EMAIL,STATION_FLAG,BUY_IN_FLAG from sys_org where ");
        } else {
            query.append("select ORG_ID,ORG_NAME,ORG_CODE,PARENT_ID,ORG_DESC,LINK_MAN,LINK_TELE,LINK_EMAIL,STATION_FLAG,BUY_IN_FLAG from sys_org");
        }
        if(orderBy != null) {
