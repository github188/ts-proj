...
public class DbResourceType extends RootDB{
    ...
    public int insert (EnResourceType en) throws ErrorException {
        ...
        query.append("insert into resource_type ( TYPE_ID,TYPE_CODE,TYPE_NAME,RESOURCE_CLASS_ID,TYPE_CONF_AMOUNT ) values ( ");
    ...
    */
    public EnResourceType findByKey(String typeId) throws ErrorException {
        ...
        StringBuffer query;
        query = new StringBuffer("select TYPE_ID,TYPE_CODE,TYPE_NAME,RESOURCE_CLASS_ID,TYPE_CONF_AMOUNT from resource_type");
    ...
    public Vector findAllLikeKey(String typeId) throws ErrorException {
        ...
        StringBuffer query = new StringBuffer();
        query.append("select TYPE_ID,TYPE_CODE,TYPE_NAME,RESOURCE_CLASS_ID,TYPE_CONF_AMOUNT from resource_type");
    ...
    public Vector findAllWhere(String where) throws ErrorException {
        ...
        StringBuffer query = new StringBuffer();
        query.append("select TYPE_ID,TYPE_CODE,TYPE_NAME,RESOURCE_CLASS_ID,TYPE_CONF_AMOUNT from resource_type where ");
        query.append(where);
        if(orderBy != null) {
            query.append(orderBy);
        }
    ...
    public Vector findAllByEn(EnResourceType en) throws ErrorException {
        ...
        if(bChanged) {
            query.insert(0,"select TYPE_ID,TYPE_CODE,TYPE_NAME,RESOURCE_CLASS_ID,TYPE_CONF_AMOUNT from resource_type where ");
        } else {
            query.append("select TYPE_ID,TYPE_CODE,TYPE_NAME,RESOURCE_CLASS_ID,TYPE_CONF_AMOUNT from resource_type");
        }
        if(orderBy != null) {
