...
<!--
  function doSubmit(form) {
    ...
    form1.FUNC_ID.value="UserPassWordSubmit";
	return true;
  }
    function doNotSave() {
	
  	//window.location.href = history.back();
  	window.location="ctrl?FUNC_ID=SheetRemindList";
  }
-->
</script>
                ...
                <div class="panelQuery">
                  ...
                  <div class="panelContent">
                   ...
                   <form action="ctrl" method="post"name="form1"onSubmit="return doSubmit(this)">
                     <input type="hidden" name="FUNC_ID" value="UserPassWordSubmit">
                     ...
                     <tr>
                        ...
                        <tr>
                          <td colspan="4" align="center" nowrap="nowrap">
                            ...
                            <input type="button" class="reset" onclick="doNotSave();" value="取消">
                          </td>
                        </tr>
                      </table>
                      </form>
