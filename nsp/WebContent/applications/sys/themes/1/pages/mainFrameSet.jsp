...
<title>中国移动通讯集团山东有限公司青岛分公司 - 资源调度管理系统</title>
</head>
  ...
  <frameset id="middleFrames" cols="200,10,*" frameborder="NO" border="0" framespacing="0">
    <frameset id="leftFrames" rows="73,39,*,14,5" cols="*" frameborder="NO" border="0" framespacing="0">
      ...
      <frameset rows="*" cols="10,*,10" frameborder="NO" border="0" framespacing="0">
        <frame src="../sys/themes/1/pages/menuLeft.jsp" name="menuLeft" scrolling="NO" noresize title="menuLeft">
        <frame src="ctrl?FUNC_ID=MenuBody" name="menuBody" scrolling="AUTO" noresize title="menuBody">
    ...
    <frame src="ctrl?FUNC_ID=SheetRemindList" name="mainFrame" title="mainFrame">
  </frameset>
