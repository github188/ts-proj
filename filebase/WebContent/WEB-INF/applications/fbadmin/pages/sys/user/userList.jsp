...
<%
  ...
  String qRoleId=xml.getInputValue("QROLE_ID");
          ...
          <div class="panelContent">
            <div class="panelContent2">
             ...
             <form name="form1" action="ctrl" method="get" onSubmit="return doSubmit(this)">
              <input type="hidden" name="FUNC_ID" value="UserQuery">
              ...
              <table>
                <tr>
                 ...
                 <td align="right">所属角色：</td>
                  <td>
                   <script>var stat = new Tower.Widget.Selector("StatSelector","QROLE_ID","ctrl?FUNC_ID=SelectRole&INPUT_TYPE=radio",{selected:["<%=qRoleId%>"]},{change:onChange})</script>
				  </td>
            ...
            <div class="panelContent2">
			  ...
			  for (int i = 0; i < userIds.length; i++) {
                ...
                <tr onmouseover="doMouseOver(this)" onmouseout="doMouseOut(this)">
                  ...
                  <td align="center" nowrap>[ <a href="JavaScript:doEdit('<%=userIds[i] %>')">编辑</a> | <a href="JavaScript:doDelete('<%=userIds[i] %>')">删除 </a>|<a href="JavaScript:doDistribute('<%=userIds[i] %>')">角色分配 </a>]</td>
                </tr>
               <%} else {%>
