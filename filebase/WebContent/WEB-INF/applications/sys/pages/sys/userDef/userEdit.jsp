                  ...
                  <input type="text" class="text"name="LOGIN_NAME"value="<%=LOGIN_NAME %>"><span class="requiredField">*</span>
                     ...
                     <input type="password" class="password" name="PASSWORD2"><% if(isAdd) { %><span class="requiredField">*</span><% } %>
                          ...
                          <td><span id="USERBIRTH">
                            <input type="text" class="date" name="USER_BIRTH" value="<%=DateFunc.FormatDateTime(USER_BIRTH) %>"><input type="button" class="calendarBtn" onclick="return showCalendar('USER_BIRTH', 'y-mm-dd');">
                      ...
                      <script>new Tower.Widget.Selector("OrgSelector","USER_ORG_ID","ctrl?FUNC_ID=SelectOrg&FLAG=All&INPUT_TYPE=radio",{selected:["<%=userOrgId%>"]},{change:onChange})</script>
                        ...
                        <td><span id="userStatId">
                             <script>new Tower.Widget.Selector("StatSelector","USER_STAT_ID","ctrl?FUNC_ID=SelectStat&INPUT_TYPE=radio",{selected:["<%=userStatId%>"]},{change:onChange})</script>
                          <span class="selectRequiredMsg">请选择一个项目。</span></span></td>
...
var sprytextfield5 = new Spry.Widget.ValidationTextField("linkTele", "phone_number", {isRequired:false, format:"phone_custom",maxChars:20});
