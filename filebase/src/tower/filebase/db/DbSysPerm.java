...
import tower.filebase.en.EnSysPerm;
...
public class DbSysPerm extends RootDB{
    ...
    */
     ...
     * Deletes from the database for table "sys_perm"
     */
    public int deleteByIndexIdxPermUserId(String userId) throws ErrorException {
        int res=-1;
     ...
     * Updates the current object values into the database.
     */
    public int updateByIndexIdxPermUserId(String userId,EnSysPerm en) throws ErrorException {
        int res = -1;
        StringBuffer query = new StringBuffer();
        boolean bChanged = false;
        query.append("update sys_perm set ");
     ...
     * Retrieve from the database for table "SysPerm"
     */
    public Vector findAllByIndexIdxPermUserId(String userId) throws ErrorException {
        Vector retRows = new Vector();
     ...
     * Counts the number of entries for this table in the database.
     */
    public int countByIndexIdxPermUserId(String userId) throws ErrorException {
        int count = -1;
        StringBuffer query = new StringBuffer();
        query.append("select count(1) as num from sys_perm");
     ...
     * Deletes from the database for table "sys_perm"
     */
    public int deleteLikeIndexIdxPermUserId(String userId) throws ErrorException {
        int res=-1;
     ...
     * Retrieve from the database for table "SysPerm"
     */
    public Vector findAllLikeIndexIdxPermUserId(String userId) throws ErrorException {
        Vector retRows = new Vector();
     ...
     * Counts the number of entries for this table in the database.
     */
    public int countLikeIndexIdxPermUserId(String userId) throws ErrorException {
        int count = -1;
        StringBuffer query = new StringBuffer();
        query.append("select count(1) as num from sys_perm");
