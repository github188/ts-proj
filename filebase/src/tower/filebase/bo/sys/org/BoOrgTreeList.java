	...
	public void doBusiness(Transaction transaction, XMLWrap requestXml,
		...
		for(int i=0;i<enOrgs.size();i++){
			...
			enOrg = (EnSysOrg)enOrgs.get(i);
				...
				requestXml.setItemValue("SYS_TREEITEM_ORG", row, "TREE_ORG_ID", enOrg.getOrgId());
				requestXml.setItemValue("SYS_TREEITEM_ORG", row, "TREE_ORG_NAME", enOrg.getOrgName());
				requestXml.setItemValue("SYS_TREEITEM_ORG", row, "TREE_PARENT_ID", enOrg.getParentId());
		}
